...
class Bean_Portfolio_Taxonomy_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'Portfolio Taxonomy', 'grille' ), // Name
			array( 'description' => esc_html__( 'A cloud of portfolio tags or categories.', 'grille' ) ) // Args
		);
	}
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'tax' ); ?>"><?php esc_html_e( 'Taxonomy:', 'grille' ); ?></label>
