 ...
 */
function grille_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function grille_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function grille_sanitize_nohtml( $nohtml ) {
 ...
 */
function grille_sanitize_html( $input ) {
 ...
 */
function grille_sanitize_number_absint( $number, $setting ) {
 ...
 * @return int Sanitized number; otherwise, the setting default.
 */
function grille_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 */
function grille_sanitize_select( $input, $setting ) {
